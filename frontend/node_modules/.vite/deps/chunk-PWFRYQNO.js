import {
  getValidChildren
} from "./chunk-4OFTEJCO.js";
import {
  chakra,
  forwardRef,
  useMultiStyleConfig,
  useTheme
} from "./chunk-27X7AN75.js";
import {
  createContext
} from "./chunk-QLMQKEP5.js";
import {
  useSafeLayoutEffect
} from "./chunk-NRE42BPT.js";
import {
  require_jsx_runtime
...
function useDescendant(options) {
  ...
  const [index2, setIndex] = (0, import_react6.useState)(-1);
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== import_react33.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
...
function MeasureLayout(props) {
  ...
  return import_react37.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react37.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react39.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size = (0, import_react40.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react43.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react43.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react43.cloneElement)(child)));
};
...
var DeprecatedLayoutGroupContext = (0, import_react46.createContext)(null);
...
var Group = (0, import_react49.forwardRef)(ReorderGroup);
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react50.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react50.useState)(initial);
    (0, import_react50.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
var Item = (0, import_react51.forwardRef)(ReorderItem);
...
//# sourceMappingURL=chunk-PWFRYQNO.js.map
